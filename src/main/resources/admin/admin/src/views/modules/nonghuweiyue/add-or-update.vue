	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="预付比例" prop="yufubili">
					<el-input v-model="ruleForm.yufubili" placeholder="预付比例" clearable  :readonly="ro.yufubili"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="预付比例" prop="yufubili">
					<el-input v-model="ruleForm.yufubili" placeholder="预付比例" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="预付款" prop="yufukuan">
					<el-input v-model="ruleForm.yufukuan" placeholder="预付款" clearable  :readonly="ro.yufukuan"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="预付款" prop="yufukuan">
					<el-input v-model="ruleForm.yufukuan" placeholder="预付款" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="违约金额" prop="weiyuejine">
					<el-input v-model="ruleForm.weiyuejine" placeholder="违约金额" clearable  :readonly="ro.weiyuejine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="违约金额" prop="weiyuejine">
					<el-input v-model="ruleForm.weiyuejine" placeholder="违约金额" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='weiyuejine'){
							this.ruleForm.weiyuejine = obj[o];
							this.ro.weiyuejine = true;
							continue;
						}
						if(o=='guige'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `nonghuweiyue/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.nonghuweiyueCrossAddOrUpdateFlag = false;
						 this.parent.search();
