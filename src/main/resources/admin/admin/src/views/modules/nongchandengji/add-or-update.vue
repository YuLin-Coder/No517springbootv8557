	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="提供数量" prop="shuliang">
					<el-input v-model="ruleForm.shuliang" placeholder="提供数量" clearable  :readonly="ro.shuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="提供数量" prop="shuliang">
					<el-input v-model="ruleForm.shuliang" placeholder="提供数量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="农户名" prop="nonghuming">
					<el-input v-model="ruleForm.nonghuming" placeholder="农户名" clearable  :readonly="ro.nonghuming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="农户名" prop="nonghuming">
					<el-input v-model="ruleForm.nonghuming" placeholder="农户名" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.nonghuming!=''&&json.nonghuming) || json.nonghuming==0) && this.$storage.get("role")!="管理员"){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `nongchandengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.nongchandengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
